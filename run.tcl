...
check_dft_rules
set_db design:dut .dft_min_number_of_scan_chains 1
...
write_hdl > led_netlist_dft.v
write_sdc > led_dft.sdc
write_sdf -nonegchecks -edges check_edge -timescale ns -recrem split > delays_dft.sdf
write_scandef > led_scanDEF.scandef
report_timing > led_timing.rep
report_area > led_area.rep
report_gates > led_GateCount.rep
report_power > led_power.rep
report_timing_summary > led_timing_summary.rep
